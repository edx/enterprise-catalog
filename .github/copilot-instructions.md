...
Enterprise Catalog is a Django-based microservice within the edX (and Open edX) ecosystem that manages enterprise customer catalogs. It acts as an intermediary between enterprise customers and the course catalog, providing curated content based on enterprise-specific requirements and filters, with integrated search capabilities and bulk content management.
